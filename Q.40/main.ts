// Album: Write a function called make_album() that builds an Object describing a
...
console.log(make_album("Saadkhan", "first album"));
console.log(make_album("hunain baseer", "second album"));
console.log(make_album("Yasir", "third album", 35));
